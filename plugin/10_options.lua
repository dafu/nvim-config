...
-- mine: vim.opt.shortmess:append("Wc") -- Reduce command line messages
...
vim.o.listchars = 'extends:…,nbsp:␣,precedes:…,tab:  ,trail:·' -- vim.opt.fillchars:append("vert:│,horiz:─,horizdown:┬,horizup:┴,verthoriz:┼,vertleft:┤,vertright:├")
...
-- mine: vim.o.formatoptions = "qjl1" -- Don't autoformat comments
...
-- mine: vim.o.softtabstop = 2
-- mine: vim.o.tabstop = 2
-- mine: vim.o.shiftwidth = 2

-- mine: vim.o.confirm = false
...
-- mine:  Schedule the setting after `UiEnter` because it can increase startup-time.
