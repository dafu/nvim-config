...
-- vnoremap <leader>me :'<,'>!gpg -ear "daniel.fusser@gmail.com"<CR>
-- vnoremap <leader>md :'<,'>!gpg -q -d<CR>
vim.api.nvim_set_keymap('v', [[<leader>mr]], [[:'<,'>!gpg -ear "daniel.fusser@gmail.com"<CR>]], { noremap = true, silent = true})
...
vim.api.nvim_set_keymap('', '<silent><leader>es', ':e ~/scratch<CR>', { noremap = true, silent = true})
vim.api.nvim_set_keymap('', '<silent><leader>bb', ':e ~/Desktop/book.md<CR>', { noremap = true, silent = true})
...
vim.api.nvim_set_keymap('',   [[<leader>eb]], [[:e C:\Users\daniel.fusser\OneDrive - PROVARIS GMBH\wiki\book.md<CR>]] , { noremap = true, silent = true})
